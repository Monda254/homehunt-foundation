  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="surface-card p-8 max-w-md w-full text-center">
        ...
        <h1 className="font-display text-2xl font-bold text-foreground">Rental Applications</h1>
        <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
          The rental applications processing and submission manager is scheduled for a future
