  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="surface-card p-8 max-w-md w-full text-center">
        ...
        <h1 className="font-display text-2xl font-bold text-foreground">Property Details</h1>
        <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
          The property details page for property ID{" "}
          <code className="rounded bg-secondary px-1 py-0.5 font-mono text-xs text-foreground font-semibold">
            {id}
          </code>{" "}
          is scheduled for a future implementation phase.
        </p>
