...
//#region node_modules/.nitro/vite/services/ssr/assets/recommendations-D7NViqNf.js
...
function RecommendationsPage() {
	...
	import_react.useEffect(() => {
		if (prefs) {
			...
			if (!(!!prefs.maxBudget || prefs.preferredLocations && prefs.preferredLocations.length > 0)) setOnboardingStep((prev) => prev === null ? 1 : prev);
		}
	}, [prefs]);
