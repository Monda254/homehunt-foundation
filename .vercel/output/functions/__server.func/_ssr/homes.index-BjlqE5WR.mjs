...
import { S as useMotion, o as Route$16, x as useAuth } from "./router-Dop2ixCg2.mjs";
import { t as AnimatedCard } from "./AnimatedCard-BeN8MzBm.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/homes.index-BjlqE5WR.js
...
var PropertyMap = ({ listings, activeListingId, onMarkerClick, onBoundsChange }) => {
	...
	const onBoundsChangeRef = (0, import_react.useRef)(onBoundsChange);
	const onMarkerClickRef = (0, import_react.useRef)(onMarkerClick);
	...
	(0, import_react.useEffect)(() => {
      ...
      `;
			...
			marker.on("click", () => {
				marker.openPopup();
				if (onMarkerClickRef.current) onMarkerClickRef.current(listing.id);
			});
