...
import { i as toErrorResponse, n as ERROR_CODES, t as AppError } from "./api-error-CUUESrGA.mjs";
import { n as supabaseAdmin$2 } from "./client.server-KNnxUzUb.mjs";
import { a as resolveRequestId, n as REQUEST_ID_HEADER, r as logger } from "./request-id-Du7XsDoM.mjs";
import { n as hasRole, t as hasPermission } from "./roles-dcbFSAkR.mjs";
import { t as readServerConfig } from "./server-config-DH8uv1J9.mjs";
...
import { l as getMyIdentity, p as logout } from "./router-CmEb8YAq.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-CmEb8YAq.js
...
var styles_default = "/assets/styles-DIIa3EgI.css";
...
async function checkDatabaseHealth() {
	...
	try {
		const { supabaseAdmin } = await import("./client.server-KNnxUzUb.mjs").then((n) => n.t);
...
var $$splitComponentImporter$2 = () => import("./dashboard.applications._id-u8aSFVrW.mjs");
var Route$6 = createFileRoute("/dashboard/applications/$id")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./dashboard.tenancies._id-Dlnmgpzz.mjs");
...
var $$splitComponentImporter = () => import("./properties._propertyId.units._unitId-snedlqei.mjs");
