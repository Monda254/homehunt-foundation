...
import { H as Info, j as Map } from "../_libs/lucide-react.mjs";
import { t as RequireAuth } from "./router-CmEb8YAq2.mjs";
import { t as DashboardLayout } from "./DashboardLayout-C9s7lFyb.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/map-DOtfKYNt.js
...
function MapComponent() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DashboardLayout, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
			...
			children: "Interactive Search Map"
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "text-sm text-muted-foreground",
			children: "Geographic search interface for rent listings and neighborhood checks."
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Map, { className: "h-6 w-6" })
				}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "The spatial mapping utility (powered by PostGIS geographic data overlays) is scheduled to release in Phase 3."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Info, { className: "h-5 w-5 text-primary shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Phase 1 Identity active:" }), " You are fully authenticated. The spatial search modules will activate in later phases."]
					})]
				})
			]
		})]
...
var SplitComponent = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RequireAuth, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapComponent, {}) });
//#endregion
